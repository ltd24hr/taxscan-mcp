...
CAMPI = [
    ...
    {"chiave": "contributi_versati_anno_precedente", "gruppo": "numeri", "obbligatorio": False, "tipo": "numero",
     "domanda": "Se lo sai, quanti contributi previdenziali hai effettivamente pagato l'anno scorso (dagli F24)? "
                "Serve per calcolare l'imposta con precisione, perché si deducono solo i contributi versati nell'anno."},
